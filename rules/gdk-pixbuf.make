...
GDK_PIXBUF_LOADER-$(PTXCONF_GDK_PIXBUF_LOADER_BMP)	+= bmp
GDK_PIXBUF_LOADER-$(PTXCONF_GDK_PIXBUF_LOADER_WBMP)	+= wbmp
GDK_PIXBUF_LOADER-$(PTXCONF_GDK_PIXBUF_LOADER_GIF)	+= gif
GDK_PIXBUF_LOADER-$(PTXCONF_GDK_PIXBUF_LOADER_ICO)	+= ico
GDK_PIXBUF_LOADER-$(PTXCONF_GDK_PIXBUF_LOADER_ANI)	+= ani
GDK_PIXBUF_LOADER-$(PTXCONF_GDK_PIXBUF_LOADER_JPEG)	+= jpeg
GDK_PIXBUF_LOADER-$(PTXCONF_GDK_PIXBUF_LOADER_PNM)	+= pnm
GDK_PIXBUF_LOADER-$(PTXCONF_GDK_PIXBUF_LOADER_RAS)	+= ras
GDK_PIXBUF_LOADER-$(PTXCONF_GDK_PIXBUF_LOADER_TIFF)	+= tiff
GDK_PIXBUF_LOADER-$(PTXCONF_GDK_PIXBUF_LOADER_XPM)	+= xpm
GDK_PIXBUF_LOADER-$(PTXCONF_GDK_PIXBUF_LOADER_TGA)	+= tga
GDK_PIXBUF_LOADER-$(PTXCONF_GDK_PIXBUF_LOADER_PCX)	+= pcx
...
GDK_PIXBUF_CONF_OPT	:= $(CROSS_AUTOCONF_USR) \
	...
	--$(call ptx/wwo, PTXCONF_GDK_PIXBUF_LOADER_JPEG)-libtiff \
