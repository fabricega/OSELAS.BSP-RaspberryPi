...
ifneq ($(call remove_quotes,$(PTXCONF_OPENSSH_BBINIT_STARTLINK)),)
	@$(call install_link, openssh, \
		../init.d/openssh, \
		/etc/rc.d/$(PTXCONF_OPENSSH_BBINIT_STARTLINK))
endif

ifneq ($(call remove_quotes,$(PTXCONF_OPENSSH_BBINIT_STOPLINK)),)
	@$(call install_link, openssh, \
		../init.d/openssh, \
		/etc/rc.d/$(PTXCONF_OPENSSH_BBINIT_STOPLINK))
endif
endif
endif
