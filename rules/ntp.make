...
ifdef PTXCONF_NTP_NTPD_STARTSCRIPT
	@$(call install_alternative, ntp, 0, 0, 0755, /etc/init.d/ntpd)

ifneq ($(call remove_quotes,$(PTXCONF_NTP_NTPD_BBINIT_STARTLINK)),)
	@$(call install_link, ntp, \
		../init.d/ntpd, \
		/etc/rc.d/$(PTXCONF_NTP_NTPD_BBINIT_STARTLINK))
endif
ifneq ($(call remove_quotes,$(PTXCONF_NTP_NTPD_BBINIT_STOPLINK)),)
	@$(call install_link, ntp, \
		../init.d/ntpd, \
		/etc/rc.d/$(PTXCONF_NTP_NTPD_BBINIT_STOPLINK))
endif
endif
endif
